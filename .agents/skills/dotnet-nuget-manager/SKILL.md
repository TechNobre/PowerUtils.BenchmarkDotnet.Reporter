...
Example: `dotnet add src/MyProject/MyProject.csproj package System.Text.Json`

### Removing a Package
Use `dotnet remove [<PROJECT>] package <PACKAGE_NAME>`.
Example: `dotnet remove src/MyProject/MyProject.csproj package System.Text.Json`
...
### User: "Add Microsoft.Extensions.Hosting to the WebApi project"
**Action**: Execute `dotnet add src/WebApi/WebApi.csproj package Microsoft.Extensions.Hosting`.

### User: "Update System.Text.Json to 10.0.8 in the whole solution"
**Action**:
1. Verify 10.0.8 exists: `dotnet package search System.Text.Json --exact-match --format json` (and parse output to confirm "10.0.8" is present).
